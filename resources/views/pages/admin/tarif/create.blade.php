...
<div class="bg-white rounded-lg shadow-md p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-semibold text-gray-800">Form Tambah Tarif</h2>
        <a href="{{ route('admin.tarif.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white font-medium py-2 px-4 rounded-lg transition duration-300 flex items-center">
    ...
    <form action="{{ route('admin.tarif.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="deskripsi" 
                      ...
                      rows="4"
                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="Masukkan deskripsi tarif (contoh: Tarif untuk pelanggan rumah tangga dengan pemakaian normal)">{{ old('deskripsi') }}</textarea>
        ...
        <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
            <a href="{{ route('admin.tarif.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-6 rounded-lg transition duration-300">
                Batal
            </a>
