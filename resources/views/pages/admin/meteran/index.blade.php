    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Kelola data meteran pelanggan</p>
            </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('admin.meteran.show', $meteran->id) }}" 
                                   class="text-green-600 hover:text-green-800 transition-colors duration-200" 
                                   title="Lihat Detail Meteran">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.meteran.edit', $meteran->id) }}" 
                    ...
                    <tr>
                        <td colspan="5" class="py-8 px-4 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-gray-500 mb-4">Mulai dengan menambahkan meteran pertama</p>
                                <a href="{{ route('admin.meteran.create') }}" 
