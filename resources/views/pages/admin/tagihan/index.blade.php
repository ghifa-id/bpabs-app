            ...
            <div class="bg-white p-4 rounded-lg border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-lg font-semibold text-gray-800">{{ $tagihan->where('status', \App\Models\Tagihan::STATUS_BELUM_BAYAR)->count() }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white p-4 rounded-lg border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-lg font-semibold text-gray-800">{{ $tagihan->where('status', \App\Models\Tagihan::STATUS_SUDAH_BAYAR)->count() }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white p-4 rounded-lg border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-lg font-semibold text-gray-800">{{ $tagihan->where('status', \App\Models\Tagihan::STATUS_TERLAMBAT)->count() }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach($tagihan as $index => $item)
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($item->status == \App\Models\Tagihan::STATUS_BELUM_BAYAR)
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                        <i class="fas fa-clock mr-1"></i>
                                        Belum Bayar
                                    </span>
                                @elseif($item->status == \App\Models\Tagihan::STATUS_SUDAH_BAYAR)
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                        <i class="fas fa-check mr-1"></i>
                                        Sudah Bayar
                                    </span>
                                @elseif($item->status == \App\Models\Tagihan::STATUS_TERLAMBAT)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <!-- Show Button -->
                                    <a href="{{ route('admin.tagihan.show', $item) }}" 
                                    ...
                                    <!-- Delete Button - link ke halaman konfirmasi -->
                                    <a href="{{ route('admin.tagihan.delete', $item) }}" 
