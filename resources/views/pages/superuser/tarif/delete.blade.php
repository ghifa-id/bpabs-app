...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div class="mt-6 flex justify-end space-x-2">
        <form action="{{ route('superuser.tarif.destroy', $tarif->id) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus tarif ini? Data yang dihapus tidak dapat dikembalikan.')">
            @csrf
            @method('DELETE')
            <button type="submit" class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition duration-300 flex items-center">
