...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form action="{{ route('superuser.meteran.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div>
            ...
            <div class="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p class="text-sm text-blue-800">
                    ...
                    <a href="{{ route('superuser.users.index') }}" class="text-blue-600 hover:text-blue-800 underline">
